...
extension DocumentSnapshot {
    ...
    func boolValue(forKey key: String, default: Bool) -> Bool {
        return getValue(forKey: key, default: `default`)
    }
    ...
    func boolValue<K: RawRepresentable>(forKey key: K, default: Bool) -> Bool where K.RawValue == String {
        return boolValue(forKey: key.rawValue, default: `default`)
    }}
